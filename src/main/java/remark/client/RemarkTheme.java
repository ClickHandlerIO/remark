...
//        ScriptInjector.fromString(bundle.js_gridmenu().getText()).setWindow(ScriptInjector.TOP_WINDOW).inject();
        ...
        ScriptInjector.fromString(bundle.js_moment().getText()).setWindow(ScriptInjector.TOP_WINDOW).inject();
        ScriptInjector.fromString(bundle.js_daterangepicker().getText()).setWindow(ScriptInjector.TOP_WINDOW).inject();
